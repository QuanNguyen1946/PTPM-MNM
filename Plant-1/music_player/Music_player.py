...
#icon
image_icon=PhotoImage(file="./Plant-1/music_player/logo.png")
root.iconphoto(False,image_icon)

Top=PhotoImage(file="./Plant-1/music_player/top.png")
Label(root,image=Top,bg="#0f1a2b").pack()

#logo
Logo=PhotoImage(file="./Plant-1/music_player/logo.png")
Label(root,image=Logo,bg="#0f1a2b").place(x=65, y=115)

#button
play_button=PhotoImage(file="./Plant-1/music_player/play.png")
Button(root,image=play_button,bg="#0f1a2b",bd=0, command=play_song).place(x=100, y=400)

stop_button=PhotoImage(file="./Plant-1/music_player/stop.png")
Button(root,image=stop_button,bg="#0f1a2b",bd=0, command=mixer.music.stop).place(x=30, y=500)

resume_button=PhotoImage(file="./Plant-1/music_player/resume.png")
Button(root,image=resume_button,bg="#0f1a2b",bd=0, command=mixer.music.unpause).place(x=115, y=500)

pause_button=PhotoImage(file="./Plant-1/music_player/pause.png")
...
#music
Menu=PhotoImage(file="./Plant-1/music_player/menu.png")
Label(root,image=Menu,bg="#0f1a2b").pack(padx=10,pady=50,side=RIGHT)

music_frame = Frame(root,bd=2,relief=RIDGE)
music_frame.place(x=330,y=350,width=560,height=250)

Button(root,text="Open Folder", width=15, height=1, font=("arial", 10, "bold"), fg="white", bg="#21b3de", command=open_folder).place(x=330, y=320)
